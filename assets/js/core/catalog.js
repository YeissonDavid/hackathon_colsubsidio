 ...
 *
 * CATÁLOGO VIGENTE: 5 LÍNEAS
 * --------------------------
 * Cupo de crédito · Crédito de consumo · Crédito de vivienda ·
 * Crédito de mujeres · Crédito educativo.
 *
 * Sustituye al catálogo de 7 del documento maestro. Los cambios respecto a
 * aquel, para que nadie los busque en vano:
 *
 *   «Compra de cartera»          → «Crédito de consumo» (absorbe consolidación)
 *   «Crédito hipotecario»        → «Crédito de vivienda»
 *   «Crédito Mujer»              → «Crédito de mujeres»
 *   «Rotativo seguros e impuestos» y «Crédito complementario» → eliminados
 *
 * El complementario nunca podía ganar: su único aporte eran 6 puntos fijos.
 * Retirarlo cierra ese hueco. El motor avanzado (domain/advanced/) mantiene
 * además una línea «Rotativo para seguros e impuestos» activada por
 * estacionalidad; ver docs/MEJORAS.md §2.1.
 *
...
(function (ORIGEN) {
  ...
  /**
   * Producto de reserva cuando ninguna señal alcanza para elegir.
   * Hoy es inalcanzable —el cupo siempre suma «Necesidad puntual»— pero se deja
   * explícito para que un cambio en las reglas no produzca `undefined`.
   */
  const FALLBACK_PRODUCT = "cupo";
  ...
  const PORTFOLIO_RULES = [
    ["Cupo de crédito", "Uso frecuente de la red; liquidez del día a día", "$150.000 – $5.000.000, reutilizable"],
    ["Crédito de consumo", "Necesidad puntual o consolidación de pasivos", "Unifica a menor tasa y mejor plazo"],
    ["Crédito de vivienda", "Evento de vivienda con estabilidad sostenida", "UVR o pesos, plazo según capacidad"],
    ["Crédito de mujeres", "Afiliada con necesidad y perfil de cuidado", "Montos adaptables + protección oncológica"],
